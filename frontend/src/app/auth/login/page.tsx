    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (data?.user && !data.user.email_confirmed_at) {
                setError('⚠️ Email not verified! Please check your inbox and click the confirmation link before logging in. Check spam folder if needed.');
                return;
            }

            // Redirect to dashboard for students/institutions (NOT admin)
